...
/* 417 */		F_SETCOLORMARKER1	/*, TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 0 */,	//カラーマーカーセット1
/* 418 */		F_SETCOLORMARKER2	/*, TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 0 */,	//カラーマーカーセット2
/* 419 */		F_SETCOLORMARKER3	/*, TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 0 */,	//カラーマーカーセット3
/* 420 */		F_SETCOLORMARKER4	/*, TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 0 */,	//カラーマーカーセット4
/* 421 */		F_SETCOLORMARKER5	/*, TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 0 */,	//カラーマーカーセット5
/* 422 */		F_SETCOLORMARKER6	/*, TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 0 */,	//カラーマーカーセット6
/* 423 */		F_SETCOLORMARKER7	/*, TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 0 */,	//カラーマーカーセット7
/* 424 */		F_SETCOLORMARKER8	/*, TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 0 */,	//カラーマーカーセット8
/* 425 */		F_SETCOLORMARKER9	/*, TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 0 */,	//カラーマーカーセット9
/* 426 */		F_SETCOLORMARKER10	/*, TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 0 */,	//カラーマーカーセット10
